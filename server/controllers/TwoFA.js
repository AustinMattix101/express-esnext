...
export const getTwoFA = (req, res) => {
    res.status(200).json({ message: `Welcome to the two factor authentication!`});
}

export const getTwoFAOn = async (req, res, next) => {
...
export const getTwoFAOff = async (req, res, next) => {
...
export const postTwoFARegister = async (req, res, next) => {
...
export const postTwoFAVerify = async (req, res, next) => {
...
export const postTwoFAValidate = async (req, res, next) => {
