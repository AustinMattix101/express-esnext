...
export async function findProfileByUsername(req, res, next) {
...
export async function writeProfile(req, res, next) {
...
export async function clearProfile(req, res, next) {
...
export async function updateProfileByUsername(req, res, next) { // Admin Only
    const params = req.params.username;
...
export async function deleteProfileByUsername(req, res, next){   // Admin Only
    const params = req.params.username;
